...
//        doCallRealMethod().when(testRectShape).getShapeType();
//        doCallRealMethod().when(testRectShape).getWidth();
//        doCallRealMethod().when(testRectShape).getHeight();
//        doCallRealMethod().when(testRectShape).getCoordinates();
//        doCallRealMethod().when(testRectShape).getStrokeColor();
//        doCallRealMethod().when(testRectShape).getFillColor();
//        doCallRealMethod().when(testRectShape).getShapeAttributes();
//        doCallRealMethod().when(testRectShape).setFillColor(any(String.class));
//        doCallRealMethod().when(testRectShape).setStrokeColor(any(String.class));
//        doCallRealMethod().when(testRectShape).setStrokeSize(anyDouble());
//        doCallRealMethod().when(testRectShape).setWidth(anyDouble());
//        doCallRealMethod().when(testRectShape).setHeight(anyDouble());
//        doCallRealMethod().when(testRectShape).setCoordinates(any(Point.class));
//        doCallRealMethod().when(testRectShape).setShapeType(any(ShapeType.class));
//
//        testRectShape.setShapeType(ShapeType.RECTANGLE);
//
...
//        Mockito.doCallRealMethod().when(testCircleShape).setStrokeSize(anyDouble());
//
//        SnapGrid testSnapGrid = mock(SnapGrid.class);
//        when(testSnapGrid.isActive()).thenReturn(false);
//        when(testSnapGrid.getGridPoints()).thenReturn(new ArrayList<Point>());
...
//        Mockito.doCallRealMethod().when(testLineShape).setStrokeSize(anyDouble());
//
//        SnapGrid testSnapGrid = mock(SnapGrid.class);
//        when(testSnapGrid.isActive()).thenReturn(false);
//        when(testSnapGrid.getGridPoints()).thenReturn(new ArrayList<Point>());
...
//        Mockito.doCallRealMethod().when(testSmileyShape).setStrokeSize(anyDouble());
//
//        SnapGrid testSnapGrid = mock(SnapGrid.class);
//        when(testSnapGrid.isActive()).thenReturn(false);
//        when(testSnapGrid.getGridPoints()).thenReturn(new ArrayList<Point>());
...
//        Mockito.doCallRealMethod().when(testTextBox).setStrokeSize(anyDouble());
//
//        SnapGrid testSnapGrid = mock(SnapGrid.class);
//        when(testSnapGrid.isActive()).thenReturn(false);
//        when(testSnapGrid.getGridPoints()).thenReturn(new ArrayList<Point>());
